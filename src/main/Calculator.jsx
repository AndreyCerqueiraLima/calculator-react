    ...
    render() {
        ...
        return (
            <div className="calculator">
                ...
                <Button click={this.clearMemory} label="AC" cName="triple" />
                <Button click={this.setOperation} label="/"  cName="operation"/>
                ...
                <Button click={this.setOperation} label="+" cName="operation"/>
                <Button click={this.addDigit} label="0" cName="double"/>
